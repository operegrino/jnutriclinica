...
public class TestePessoa {
	...
	public void testPessoaWithNullName() throws Exception {
		try{
			pessoa1 = new Pessoa(null, 40, "12345678911", "Rua Nove de Novembro, Nº 235", 
					new GregorianCalendar(1985, 01, 10), "91882525", anamnese);
	...
	public void testPessoaWithEmptyName() throws Exception {
		try{
			pessoa2 = new Pessoa("", 46, "15709952112", "Rua Jose Agripino, Nº 36", new GregorianCalendar(1964, 03, 27), "88871265", anamnese);
	...
	public void testPessoaWithNegativeAge() throws Exception{
		try{
			pessoa2 = new Pessoa("Roberto Sousa do Nascimento", -15, "15709952112", "Rua Jose Agripino, Nº 36", new GregorianCalendar(1964, 03, 27), "88871265", anamnese);
	...
	public void testPessoaWithNullCPF()throws Exception{
		try{
			new Pessoa("Ana Maria da Silva", 46, null, "Rua Jose Agripino, N� 36", new GregorianCalendar(1964, 03, 27), "88871265", anamnese);
