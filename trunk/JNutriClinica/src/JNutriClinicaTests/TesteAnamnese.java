...
public class TesteAnamnese {
	...
	public void setUp() throws Exception {
		new Anamnese(80.5,1.89, false, 65.6,70.1,"Dor no estomago", patologiaChave.CARDIOPATIA, false,3);
		new Anamnese(55.4,1.66, true, 97.2,78.3,"Dor", patologiaChave.DIABETES, true,8);
		new Anamnese(49.6,1.77, false, 65.6,70.1,"Dor no estomago", patologiaChave.PATOLOGIA_RENAL, true,1);
	}
	...
	public void testAnamneseSetPerdeuPeso() throws Exception {
		Anamnese anamnese1 = new Anamnese(50.1,1.99, false, 65.6,70.1,"Dor no estomago", 
				patologiaChave.CARDIOPATIA, false,3);
	...
	public void testAnamneseSetPatologiaChave() throws Exception {
			Anamnese anamnese2 = new Anamnese(66.6,1.70, false, 65.6,70.1,"Dor no estomago", 
					patologiaChave.CARDIOPATIA, false,3);
	...
	public void testAnamneseSetTomaMedicamentos() throws Exception {
		Anamnese anamnese3 = new Anamnese(66.6,1.12, false, 65.6, 50.4,"Dor no estomago", 
					patologiaChave.CARDIOPATIA, false,3);
	...
	public void testAnamneseNegativeAltura()throws Exception{
		try{
			...
			Assert.assertEquals("Erro na Altura", "valor invalido.", e.getMessage());
		}
	}
